...
public class UtilityInitial  {
    ...
    public static int[] tabIcon_pressed = new int[] {R.mipmap.ic_tabbar_red_store,R.mipmap.ic_tabbar_red_limit,R.mipmap.ic_tabbar_red_mine,R.mipmap.ic_tabbar_red_more};
